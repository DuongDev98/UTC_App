...
class EditProfile extends Component {
  ...
  async capNhatDuLieu() {
    let o = {
      ...
      tinhthanhid: this.state.tinhthanhid,
      quanhuyenid: this.state.quanhuyenid,
      phuongxaid: this.state.phuongxaid,
  ...
  render() {
    ...
    return (
      <>
        {this.state.loadding ? (
          <Loadding spinnerKey="loadding..." visible={this.state.loadding} />
        ) : (
